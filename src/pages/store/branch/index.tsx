...
import { branchColumns } from '../_config/columns';
import { IBranchTableData } from '../_config/columns/columns.type';
import { useStoreBranches } from '../_config/query';
...
const Branch = () => {
	...
	const [updatedData, setUpdatedData] = useState<IBranchTableData | null>(null);

	const handleUpdate = (row: Row<IBranchTableData>) => {
	...
	const handleDelete = (row: Row<IBranchTableData>) => {
		setDeleteItem({
	...
	const handleDeleteAll = (rows: Row<IBranchTableData>[]) => {
